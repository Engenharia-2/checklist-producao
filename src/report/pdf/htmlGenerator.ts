...
const renderMiliohmimetroHtml = (checklist: Record<string, any>): string => {
  ...
  html += generateChecklistSection("Montagem (Mecânica)", [
    ...
    },
    {
      ...
      label:
        "Verificar organização interna dos cabos com abraçadeiras ou Termo-encolhíveis",
    },
    {
      id: "mech_glue_connectors",
      label:
        "Passar cola quente em todos os cabos com conexão KK, nos parafusos da placa e parafusos das entradas de medição.",
    },
    {
      id: "mech_foam_sides",
  ...
  html += generateChecklistSection("Pré-Energização", [
    {
      ...
      label:
        "Verificar conexões das fontes e da placa, desconectar USB's da placa e cabo fita, conectar apenas depois de energizar a primeira vez",
    },
    {
      id: "pre_attach_serial",
      label:
        "Anexar número de série do produto ao número de série da placa na planilha de assistência de placa",
    },
  ]);
  ...
  html += generateChecklistSection("Energização", [
    {
      ...
      label:
        "Verificar a tensão da fonte 5V ANTES DE CALIBRAR, ajustar em 4.95V",
    },
  ...
  html += generateChecklistSection("Software", [
    ...
    },
    {
      id: "soft_copy_files",
      label:
        "Colocar os arquivos do pendrive na pasta 'mohm-lhf/data', após a calibração",
    },
    {
      id: "soft_test_pdf",
    ...
    },
    {
      ...
      label:
        "Deixar valores de configuração no padrão (temperatura de referência 25, numero aquisições 5, tempo estabilização 1)",
    },
    {
      id: "soft_insert_serial",
      label:
        "Inserir número de série do produto na interface gráfica (menu 'configuração')",
    },
    {
      id: "soft_compile_path",
      label:
        "Compilar o software e apontar seu caminho para inicializar junto ao miliohmímetro",
    },
    {
      id: "soft_config_sd",
  ...
  html += generateChecklistSection("Calibração Interna", [
    {
      id: "calib_all_scales",
      label:
        "Calibrar todas as escalas visando identificar possíveis falhas de medição",
    },
    { id: "calib_battery", label: "Realizar calibração da bateria" },
    {
      id: "calib_temperature_kappo",
      label:
        "Realizar calibração da temperatura com utilização do KAPPO (utilizar o gráfico abaixo).",
    },
  ]);
  ...
  html += generateChecklistSection("Finalização", [
    {
      id: "final_glue_usb",
      label:
        "Após todos os testes, passar cola quente nas entradas USB's e HDMI",
    },
    ...
    },
    {
      ...
      label:
        'Copiar os valores da calibração para um pendrive atráves do botão "Salvar" na tela de "Valores Calibrados", e salvar esse arquivo na pasta de "Gestão de qualidade"',
    },
    {
      id: "final_copy_alldata",
      label:
        "Copiar o arquivo ALLDATA do pendrive para a pasta de GESTÃO DA QUALIDADE do equipamento.",
    },
  ]);
  ...
  if (checklist.images && checklist.images.length > 0) {
    ...
    const imageItems: AttachedImage[] = checklist.images.map((uri: string) => ({
      uri,
    }));
...
const renderMegohmetroHtml = (checklist: Record<string, any>): string => {
  ...
  html += generateChecklistSection("Finalização", [
    ...
    },
    {
      ...
      label:
        "Enviar manual impresso, certificado de calibração, cabos com Garras e cabo de alimentação",
    },
    {
    ...
    },
    {
      ...
      label:
        "Fazer teste de conexão com o Software e gerar o relatório de Dados.",
    },
    {
      id: "mega_final_lacre_foto",
      label:
        "Fazer o lacre internamente, tirar foto e salvar na pasta do Megôhmetro",
    },
    {
...
const renderSurge4kvHtml = (checklist: Record<string, any>): string => {
  ...
  html += generateChecklistSection("Energização", [
    ...
    },
    {
      ...
      label:
        "Utilizando o PENDRIVE padrão de imagem para o Windows, conforme procedimento adicionar a imagem do Windows 10 no equipamento e configurar a placa ETHERNET conforme Procedimento.",
    },
    {
    ...
    { id: "surge4kv_energ_touch", label: "Testar touch-screen da tela" },
    {
      ...
      label:
        "Teste de placas - executar teste de tensão e aplicar ganho no Software do surge",
    },
    {
    ...
    },
    {
      ...
      label:
        "Verificar se a ultima versão do software esta atualizada no surge",
    },
    {
    ...
    },
    {
      ...
      label:
        'Configurar o Windows para não desligar nem suspender (nunca). Configurar o botão de energia para "Desligar" e o botão de Suspensão para "nada a fazer".',
    },
    {
      id: "surge4kv_energ_led",
      label:
        "Verificar o funcionamento do LED RGB na face do produto. Deve Acender em branco ao iniciar o software.",
    },
    { id: "surge4kv_energ_wifi", label: "Testar funcionamento do Wi-Fi" },
    {
      id: "surge4kv_energ_instalar_softwares",
      label:
        "Instalar softwares necessários (conforme descritivo). PRINCIPALMENTE “Team Viewer 12” e software do Osciloscópio Hantek.",
    },
  ]);
  ...
  html += generateChecklistSection("Finalização", [
    { id: "surge4kv_final_logo", label: "Inserir Logomarca do cliente" },
    {
      ...
      label:
        "Apagar demais padrões de testes (eventualmente criados durante Testes na LHF). NÃO APAGAR se for conserto.",
    },
    {
    ...
    },
    {
      ...
      label:
        "Executar testes repetitivos em toda a faixa de tensões de saída, Principalmente na tensão máxima",
    },
    {
      id: "surge4kv_final_alimentar_110",
      label:
        "Alimentar com 110-127Vca e testar se tensão de saída chega na Máxima",
    },
    {
    ...
    },
    {
      ...
      label:
        "Inspeção mecânica/visual final: parafusos, encaixes, colas, riscos, Sujeira, cabos, suporte da tela.",
    },
    ...
    },
    {
      ...
      label:
        "Etiqueta com numero de série na tampa da maleta. Etiquetas de número de série, de entrada de energia e de calibração dentro Da maleta.",
    },
    {
    ...
    },
    {
      ...
      label:
        "3 cabos bobina e motor refazer o cadastro com teste inverso e Mudar para 2k.",
    },
    {
    ...
    { id: "surge4kv_final_prensa_cabos", label: "Apertar prensa-cabos" },
    {
      ...
      label:
        "Cola-quente em todos os conectores e componentes que não Tenham trava ou arruela de pressão",
    },
    {
      id: "surge4kv_final_teste_vibracao",
      label:
        "Realizar teste de vibração na plataforma vibratória FAIXA DE 1Hz À 10HZ CERCA DE 10 MIN.",
    },
    {
      id: "surge4kv_final_testes_repetitivos_pos_vib",
      label:
        "Executar testes repetitivos em toda a faixa de tensões de saída, Principalmente na tensão máxima após a vibração.",
    },
    {
      id: "surge4kv_final_limpar_report",
      label:
        "Limpar resultados da pasta report (deletar o arquivo report.3DB) Antes de enviar. NÃO DELETAR se for conserto. Refazer o Teste padrão",
    },
    {
      id: "surge4kv_final_backup_rede",
      label:
        "Fazer backup da pasta do software do surge para a rede (em “LHF\\PROJETOS\\Surge Teste - Sinapse\\SURGE TESTE - GESTÃO DA QUALIDADE”)",
    },
    {
      id: "surge4kv_final_print_calibracao",
      label:
        "Tirar print dos valores de calibração após o equipamento ser calibrado pela calibração externa e salvar nos campos abaixo",
    },
  ]);
  ...
  // Imagens
  if (
    checklist.surge4kv_ident_prints &&
    checklist.surge4kv_ident_prints.length > 0
  ) {
    const imageItems: AttachedImage[] = checklist.surge4kv_ident_prints.map(
      (uri: string) => ({ uri }),
    );
    html += generateImageSection("Imagens Anexadas", imageItems);
  }
...
const renderSurge15kvHtml = (checklist: Record<string, any>): string => {
  ...
  // Imagens
  if (
    checklist.surge15kv_ident_prints &&
    checklist.surge15kv_ident_prints.length > 0
  ) {
    const imageItems: AttachedImage[] = checklist.surge15kv_ident_prints.map(
      (uri: string) => ({ uri }),
    );
    html += generateImageSection("Imagens Anexadas", imageItems);
  }
...
export const createPdfContent = (
  ...
  const htmlContent = `
    ...
    <head>
      <meta charset="UTF-8">
      <style>
        /* Using @page for headers and footers, the correct way for paged media */
        @page {
            /* We leave space for the header and footer in the margins */
            margin-top: 3cm;
            margin-bottom: 2.5cm;
            margin-left: 1cm;
            margin-right: 1cm;
        ...
        * { box-sizing: border-box; }
        body { 
            ...
            margin: 0; 
            padding: 0;
            /* No extra padding needed, @page margins handle it */
        }
        .main-content { width: 100%; }
        
        /* The header and footer divs are gone, so their styles are removed */
        
        .section { 
            margin-bottom: 1cm; 
            /* padding-top is no longer needed, page margin handles it */
            page-break-inside: avoid; 
            break-inside: avoid;
        }
        
        .section-title { font-size: 16pt; color: #005a9c; border-bottom: 1px solid #ccc; padding-bottom: 5px; margin-bottom: 15px; page-break-after: avoid; break-after: avoid; padding-top: 1cm; }
        ...
        /* image-group-section padding-top is also removed */
        .image-group-section { margin-top: 25px; page-break-before: auto; }
        .image-grid { display: flex; flex-wrap: wrap; gap: 1cm; justify: center; }
